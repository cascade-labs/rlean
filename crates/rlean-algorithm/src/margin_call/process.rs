...
pub fn process_margin_call_scan<P: MarginCallFillProcessor>(
    ...
    order_processor: &rlean_orders::order_processor::OrderProcessor,
    model: &MarginCallModelKind,
    time: rlean_core::DateTime,
    next_margin_call_time: &mut rlean_core::DateTime,
    trade_bars: &std::collections::HashMap<u64, rlean_data_tables::TradeBar>,
    quote_bars: &std::collections::HashMap<u64, rlean_data_tables::QuoteBar>,
    ...
    *next_margin_call_time = rlean_core::NanosecondTimestamp(time.0 + MARGIN_CALL_FREQUENCY_NS);
