...
impl PyOrderEvent {
    ...
    #[getter]
    fn fill_price_currency(&self) -> &str {
        &self.fill_price_currency
    }
    ...
    #[getter]
    fn absolute_fill_quantity(&self) -> f64 {
    ...
    fn is_fill(&self) -> bool {
        self.status_raw.is_fill()
    }

    /// Brokerage commission for this fill.
    #[getter]
    fn order_fee(&self) -> f64 {
        self.order_fee
    }
    ...
    #[getter]
    fn trailing_as_percentage(&self) -> bool {
