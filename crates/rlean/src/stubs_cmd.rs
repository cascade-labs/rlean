...
class FuncSecuritySeeder:
    ...
    def __init__(self, seed_function: Any) -> None: ...
    def seed_security(self, security: Security) -> bool: ...
    def SeedSecurity(self, security: Security) -> bool: ...

class BrokerageModelSecurityInitializer:
    """Initializes newly added securities and optionally seeds their market price."""

    def __init__(self, brokerage_model: Any = None, security_seeder: Any = None) -> None: ...
...
class Portfolio:
    ...
    @property
    def invested(self) -> bool:
        """Documented LEAN whole-portfolio investment state."""
        ...
...
class UniverseSettings:
    """LEAN universe settings applied when universe selection adds securities."""
    resolution: Resolution
    leverage: float
    fill_forward: bool
...
class DateRules:
    def every_day(self) -> DateRule: ...
    def EveryDay(self) -> DateRule: ...

class TimeRule: ...

class TimeRules:
    def at(self, hour: int, minute: int, second: int = 0) -> TimeRule: ...
    def At(self, hour: int, minute: int, second: int = 0) -> TimeRule: ...
    def after_market_open(self, symbol: Symbol | Security | str | None = None, minutes_after_open: int = 0) -> TimeRule: ...
    def AfterMarketOpen(self, symbol: Symbol | Security | str | None = None, minutes_after_open: int = 0) -> TimeRule: ...
...
class ScheduledUniverse:
    def __init__(
        ...
        date_rule: DateRule,
        time_rule: TimeRule,
        selector: Callable[[datetime], list[Symbol | Security | str]],
        settings: UniverseSettings | None = None,
    ) -> None: ...
    def get_trigger_times(self, start: datetime, end: datetime) -> list[datetime]: ...
    def GetTriggerTimes(self, start: datetime, end: datetime) -> list[datetime]: ...

class SecurityChanges:
    @property
    def added_securities(self) -> list[Security]: ...
    @property
    def removed_securities(self) -> list[Security]: ...
    @property
    def AddedSecurities(self) -> list[Security]: ...
    @property
    def RemovedSecurities(self) -> list[Security]: ...
...
class QCAlgorithm:
    ...
    @property
    def brokerage_model(self) -> Any: ...
    @property
    def BrokerageModel(self) -> Any: ...
    def set_security_initializer(self, initializer: Any) -> None: ...
    def SetSecurityInitializer(self, initializer: Any) -> None: ...
    def add_cash(self, amount: float) -> None: ...
    def set_name(self, name: str) -> None: ...
    def get_parameter(self, name: str, default: Optional[str] = None) -> Optional[str]: ...
    def set_warm_up(self, bars_or_days: int, resolution: Resolution | None = None) -> None: ...
    ...
    def history_range(self, symbol: Symbol | Security | str, start: Any, end: Any, resolution: Resolution) -> Any:
        ...
        ...
    def get_last_known_prices(self, symbol: Symbol | Security | str) -> list[TradeBar]: ...
    def get_last_known_price(self, symbol: Symbol | Security | str) -> TradeBar | None: ...
    def History(self, *args: Any) -> Any: ...
    def GetLastKnownPrices(self, symbol: Symbol | Security | str) -> list[TradeBar]: ...
    def GetLastKnownPrice(self, symbol: Symbol | Security | str) -> TradeBar | None: ...
    ...
    @property
    def UniverseSettings(self) -> UniverseSettings: ...
    @property
    def date_rules(self) -> DateRules: ...
    @property
    def DateRules(self) -> DateRules: ...
    @property
    def time_rules(self) -> TimeRules: ...
    @property
