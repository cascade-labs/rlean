//! `rlean-data-providers` — framework traits and types.
//!
...
//! ```text
//! rlean-core
//!   └─ rlean-data          (TradeBar, QuoteBar, …)
//!        └─ rlean-storage  (IcebergStore, schema conversion, …)
//!             └─ rlean-data-providers   ← this crate (traits + local provider)
