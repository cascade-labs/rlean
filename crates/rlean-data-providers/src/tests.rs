...
mod custom_data_tests {
    ...
    impl ICustomDataSource for MockVixSource {
        ...
        fn reader(
            ...
            let time = rlean_core::DateTime::from(date.and_hms_opt(0, 0, 0).unwrap().and_utc());
    ...
    fn test_reader_parses_valid_data_line() {
        ...
        assert_eq!(
            point.end_time,
            point.time + rlean_core::TimeSpan::from_days(1)
        );
