...
use rlean_data::custom::{CustomDataConfig, CustomDataPoint, CustomDataQuery, CustomDataSource};
...
///
/// Because `ICustomDataSource` lives in `rlean-data-providers` (not `rlean-plugin`),
...
pub trait ICustomDataSource: Send + Sync {
    ...
    fn default_resolution(&self) -> rlean_core::Resolution {
        rlean_core::Resolution::Daily
    }
    ...
    fn default_resolution_for_ticker(&self, _ticker: &str) -> rlean_core::Resolution {
