...
use crate::BacktestRunResult as BacktestResult;
use rlean_algorithm::charting::{Chart, ChartCollection, ChartPoint, Series, SeriesType};
...
struct BacktestResultJson<'a> {
    ...
    statistics: &'a rlean_statistics::PortfolioStatistics,
    #[serde(rename = "Orders")]
    orders: std::collections::BTreeMap<i64, &'a rlean_orders::Order>,
    #[serde(rename = "OrderEvents")]
    order_events: &'a [rlean_orders::OrderEvent],
    #[serde(rename = "Charts")]
    ...
    alpha_analytics: &'a rlean_alpha::AlphaAnalytics,
}
...
fn build_alpha_analytics_section(a: &rlean_alpha::AlphaAnalytics) -> String {
...
fn build_alpha_ic_chart(a: &rlean_alpha::AlphaAnalytics) -> String {
...
fn build_alpha_correlation_heatmap(a: &rlean_alpha::AlphaAnalytics) -> String {
    let m = &a.correlation;
    if m.names.len() < 2 {
        return String::new();
    }
...
fn build_alpha_ranking(a: &rlean_alpha::AlphaAnalytics) -> String {
