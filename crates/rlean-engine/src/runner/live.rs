...
impl LiveSubscriptionSet {
    fn subscribe_initial(
        queue: &mut rlean_live::DataQueueHandlerManager,
        subscriptions: &[SubscriptionDataConfig],
        ...
        let job = rlean_data::LiveNodePacket {
    ...
    fn unsubscribe_all(&mut self, queue: &mut rlean_live::DataQueueHandlerManager) {
...
struct LiveCustomSubscriptionSet {
    receiver: Receiver<rlean_core::Result<LiveDataItem>>,
    sender: Sender<rlean_core::Result<LiveDataItem>>,
    stop: Arc<AtomicBool>,
...
fn custom_source_for_config(
    ...
    rlean_data::CustomSubscriptionMetadata,
)> {
...
async fn run_live_custom_poller(
    ...
    while !stop.load(Ordering::Relaxed) {
        let utc_now = rlean_core::DateTime::now();
...
mod tests {
    ...
    use rlean_orders::{Order, OrderEvent, OrderType, TransactionManager};
    ...
    impl DataQueueHandler for ScriptedLiveHandler {
        fn set_job(&mut self, _job: &rlean_data::LiveNodePacket) -> Result<()> {
    ...
    impl RecordingBridge {
        ...
        fn with_order_state(mut self, symbol: Symbol) -> Self {
            ...
            self.portfolio = Some(Arc::new(
                rlean_algorithm::portfolio::SecurityPortfolioManager::new_live(dec!(100000)),
            ));
            self
        }
    }

    impl rlean_algorithm::lifecycle::AlgorithmStateAccess for RecordingBridge {}

    impl rlean_algorithm::lifecycle::LifecycleBridge for RecordingBridge {
        ...
        fn on_otm_expiry(
            &mut self,
            _contract: rlean_options::OptionContract,
        ...
        fn on_splits(
            &mut self,
            _splits: &HashMap<u64, rlean_data::Split>,
            _services: &mut dyn AlgorithmServices,
        ) {
        }
        ...
        fn on_dividends(
            &mut self,
            _dividends: &HashMap<u64, rlean_data::Dividend>,
            _services: &mut dyn AlgorithmServices,
        ) {
        }
        ...
        fn on_delistings(
            &mut self,
            _delistings: &HashMap<u64, rlean_data::Delisting>,
            _services: &mut dyn AlgorithmServices,
        ) {
        }
        ...
        fn on_symbol_changed_events(
            &mut self,
            _events: &HashMap<u64, rlean_data::SymbolChangedEvent>,
            _services: &mut dyn AlgorithmServices,
        ) {
        }
        ...
        fn select_custom_universe_changes(
            ...
            _utc_ns: i64,
            _resolution: Resolution,
            _custom_data: &HashMap<String, Vec<rlean_data::CustomDataPoint>>,
            _services: &mut dyn AlgorithmServices,
        ) -> Vec<UniverseSelection> {
            Vec::new()
        }
        ...
        fn portfolio_value(&self) -> rlean_core::Price {
            dec!(100000)
        }

        fn starting_cash(&self) -> rlean_core::Price {
            dec!(100000)
        }
        ...
        fn portfolio(&self) -> Option<Arc<rlean_algorithm::portfolio::SecurityPortfolioManager>> {
        ...
        fn order_fee(&self, _order: &Order, _fill_price: rlean_core::Price) -> rlean_core::Price {
            dec!(0)
        }

        fn contract_multiplier_for_symbol(&self, _symbol: &Symbol) -> rlean_core::Price {
            dec!(1)
        }
        ...
        fn validate_order_buying_power(
            &self,
            _order: &Order,
            _fill_price: rlean_core::Price,
            _fee: rlean_core::Price,
    ...
    async fn live_config(log: EventLog, items: Vec<LiveDataItem>) -> Option<LiveRunConfig> {
        ...
        Some(LiveRunConfig {
            ...
            live_data_queue: rlean_live::DataQueueHandlerManager::new(vec![Box::new(
    ...
    fn live_subscription_set_uses_stacked_queue_provider_order() {
        ...
        let mut queue = rlean_live::DataQueueHandlerManager::new(vec![
    ...
    fn manager_with_order_state(
        ...
        Arc<rlean_algorithm::portfolio::SecurityPortfolioManager>,
    ) {
        let log = EventLog::default();
    ...
    struct NoopHistory;
    impl rlean_algorithm::lifecycle::AlgorithmHistoryService for NoopHistory {
        fn history(
            &self,
    ...
    fn drain_until<F: Fn() -> bool>(
        ...
        portfolio: &Arc<rlean_algorithm::portfolio::SecurityPortfolioManager>,
    ...
    impl Brokerage for PaperFillMock {
        ...
        fn place_order(&mut self, _order: rlean_orders::Order) -> rlean_core::Result<bool> {
            Ok(true)
        }
        fn update_order(&mut self, _order: &rlean_orders::Order) -> rlean_core::Result<bool> {
            Ok(true)
        }
        fn cancel_order(&mut self, _order: &rlean_orders::Order) -> rlean_core::Result<bool> {
            Ok(true)
        }
        fn get_open_orders(&self) -> Vec<rlean_orders::Order> {
            Vec::new()
        }
        fn get_cash_balance(&self) -> Vec<(String, rlean_core::Price)> {
    ...
    use rlean_alpha::{Insight, InsightDirection, NullAlphaModel};
    use rlean_brokerages::BrokerageHolding;
    use rlean_core::TimeSpan as CoreTimeSpan;
    ...
    impl rlean_algorithm::lifecycle::AlgorithmStateAccess for FrameworkBridge {
        fn algorithm_state(&self) -> Option<Arc<Mutex<QcAlgorithm>>> {
            Some(self.state.clone())
        }
    }

    impl rlean_algorithm::lifecycle::LifecycleBridge for FrameworkBridge {
        fn initialize(&mut self, _services: &mut dyn AlgorithmServices) -> anyhow::Result<()> {
            Ok(())
        }
        fn on_data(
    ...
    fn framework_manager_with_history(
        state: Arc<Mutex<QcAlgorithm>>,
        history: Arc<dyn rlean_algorithm::lifecycle::AlgorithmHistoryService>,
    ) -> (
        AlgorithmManager<FrameworkBridge>,
        crate::AlgorithmRuntimeContext,
    ) {
    ...
    impl rlean_algorithm::lifecycle::AlgorithmHistoryService for SeededHistory {
        fn history(
            &self,
    ...
    fn restored_insight_produces_buy_order_submitted_to_brokerage() {
...

        {
            ...
            fw.restore_insights(
                rlean_alpha::InsightCollectionSnapshot {
        ...
        let slice = rlean_data::Slice::new(DateTime::now());
