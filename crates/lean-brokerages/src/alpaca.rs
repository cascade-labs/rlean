...
use crate::brokerage_model::BrokerageModel;
...
impl Default for AlpacaBrokerageModel {
    fn default() -> Self { Self { is_live: false } }
}

impl AlpacaBrokerageModel {
    pub fn new(is_live: bool) -> Self { Self { is_live } }
    pub fn paper() -> Self { Self::new(false) }
    pub fn live() -> Self { Self::new(true) }
}
