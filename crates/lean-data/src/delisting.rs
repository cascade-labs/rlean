...
impl Delisting {
    pub fn new(symbol: Symbol, time: DateTime, price: Price, delisting_type: DelistingType) -> Self {
        Delisting { symbol, time, price, delisting_type }
    }

    pub fn is_warning(&self) -> bool { self.delisting_type == DelistingType::Warning }
}

impl BaseData for Delisting {
    fn data_type(&self) -> BaseDataType { BaseDataType::Delisting }
