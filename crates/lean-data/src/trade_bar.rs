...
impl TradeBar {
    ...
    pub fn spread_pct(&self) -> Decimal {
        if self.close.is_zero() { return dec!(0); }
    ...
    pub fn from_lean_csv_line(line: &str, symbol: Symbol, date: chrono::NaiveDate, resolution: Resolution) -> Option<Self> {
