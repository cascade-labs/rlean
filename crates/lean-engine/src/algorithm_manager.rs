    ...
    B: AlgorithmBridge,
{
    ...
    pub fn starting_cash(&self) -> lean_core::Price {
    ...
    pub fn portfolio_value(&self) -> lean_core::Price {
        self.algorithm.portfolio_value()
    }

    pub fn transactions(&self) -> Option<Arc<lean_orders::TransactionManager>> {
        self.algorithm.transactions()
    }

    pub fn portfolio(&self) -> Option<Arc<lean_algorithm::portfolio::SecurityPortfolioManager>> {
