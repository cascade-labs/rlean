...
mod tests {
    ...
    fn bar_collections_support_membership_and_indexing() {
        ...
        let view = SliceView::new(frame.clone());
        let symbol = Symbol::create_equity("SPY", &Market::usa());
        let mut slice = Slice::new(rlean_core::DateTime::from(
    ...
    fn slice_view_exposes_custom_data_latest_and_membership() {
        ...
        let stamp = rlean_core::DateTime::from(day.and_hms_opt(16, 0, 0).unwrap());
    ...
    fn trade_bar_view_keeps_original_slice_after_frame_advances() {
        ...
        let view = SliceView::new(frame.clone());
        let symbol = Symbol::create_equity("SPY", &Market::usa());
        let mut first_slice = Slice::new(rlean_core::DateTime::from(
            chrono::NaiveDate::from_ymd_opt(2024, 1, 2)
                .unwrap()
                .and_hms_opt(9, 31, 0)
                .unwrap(),
        ...
        let mut second_slice = Slice::new(rlean_core::DateTime::from(
            chrono::NaiveDate::from_ymd_opt(2024, 1, 2)
                .unwrap()
                .and_hms_opt(9, 32, 0)
                .unwrap(),
