...
//!
//! Rust users get the native `rlean-indicators` types directly. Python-facing
...
pub use rlean_indicators::williams_r::WilliamsR as WilliamsPercentR;
pub use rlean_indicators::*;
...
fn current_point<I: rlean_indicators::indicator::Indicator>(
    indicator: &I,
...
impl IndicatorResultView {
    pub fn from_result(result: rlean_indicators::IndicatorResult) -> Self {
        Self {
...
pub struct SimpleMovingAverage {
    inner: Arc<Mutex<rlean_indicators::Sma>>,
}

impl SimpleMovingAverage {
    pub fn new(period: usize) -> Self {
        Self {
            inner: Arc::new(Mutex::new(rlean_indicators::Sma::new(period))),
        }
    }
    ...
    pub fn registered_handle(
        &self,
    ) -> Arc<dyn rlean_algorithm::lifecycle::RegisteredIndicatorBridge> {
        Arc::new(self.clone())
    }
}
...
pub struct ExponentialMovingAverage {
    inner: Arc<Mutex<rlean_indicators::Ema>>,
}

impl ExponentialMovingAverage {
    pub fn new(period: usize) -> Self {
        Self {
            inner: Arc::new(Mutex::new(rlean_indicators::Ema::new(period))),
        }
    }
...
pub struct RelativeStrengthIndex {
    inner: Arc<Mutex<rlean_indicators::Rsi>>,
}

impl RelativeStrengthIndex {
    pub fn new(period: usize) -> Self {
        Self {
            inner: Arc::new(Mutex::new(rlean_indicators::Rsi::new(period))),
        }
    }
...
pub struct BollingerBandsIndicator {
    inner: Arc<Mutex<rlean_indicators::BollingerBands>>,
}

impl BollingerBandsIndicator {
    pub fn new(period: usize, k: f64) -> Self {
        Self {
            inner: Arc::new(Mutex::new(rlean_indicators::BollingerBands::new(
                period,
                price_from_f64(k),
            ))),
        }
...
pub struct MacdIndicator {
    inner: Arc<Mutex<rlean_indicators::Macd>>,
}

#[cfg_attr(feature = "python", pyo3::pyclass(name = "AverageTrueRange"))]
pub struct AverageTrueRange {
    inner: Arc<Mutex<rlean_indicators::Atr>>,
}

impl AverageTrueRange {
    pub fn new(period: usize) -> Self {
        Self {
            inner: Arc::new(Mutex::new(rlean_indicators::Atr::new(period))),
        }
    }
    pub fn is_ready(&self) -> bool {
        self.inner
...
impl MacdIndicator {
    pub fn new(fast_period: usize, slow_period: usize, signal_period: usize) -> Self {
        Self {
            inner: Arc::new(Mutex::new(rlean_indicators::Macd::new(
                fast_period,
                slow_period,
                signal_period,
            ))),
