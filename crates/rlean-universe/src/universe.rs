use rlean_core::{DataNormalizationMode, DateTime, Resolution, Symbol};
...
pub struct UniverseSettings {
    ...
    pub minimum_time_in_universe: rlean_core::TimeSpan,
    pub leverage: f64,
...
impl Default for UniverseSettings {
    fn default() -> Self {
        UniverseSettings {
            ...
            minimum_time_in_universe: rlean_core::TimeSpan::ONE_DAY,
            leverage: 1.0,
...
pub trait Universe: Send + Sync {
    fn select_symbols(&self, utc_time: DateTime, data: &[rlean_core::Symbol]) -> Vec<Symbol>;
